...
public class Welcome : EditorWindow {
	...
	[MenuItem("Tools/WALL BALL/FIRST START INFORMATIONS")]
	...
	void OnGUI()
	{
		...
		if (GUI.Button (new Rect (10, 10, 300, 150), "OPEN WALL BALL DOCUMENTATION")) {
			Application.OpenURL (Application.dataPath + "//Documentation//" + "WallBall.pdf");
		}
		...
		{
			Application.OpenURL("https://www.assetstore.unity3d.com/en/#!/content/49573");
		}
